...
class NotificationManager {
    ...
    async sendNotification(title, body, icon = "", tag = "notify", url = "") {
    ...
    autoNotifyWhenHidden(title, body, icon = "", interval = 60000, url = "") {
        document.addEventListener("visibilitychange", () => {
            ...
            if (document.visibilityState === "hidden") {
                ...
                this.hiddenInterval = setInterval(() => {
                    this.sendNotification(title, body, icon, "hidden-notify", finalURL);
                }, interval);
            } else {
                clearInterval(this.hiddenInterval);
                this.hiddenInterval = null;
                this.sendNotification("Welcome Back!", "We're happy to see you!", icon, "hidden-notify", finalURL);
            }
        });
    }
}
